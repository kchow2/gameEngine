...
public class WeaponComponent implements IGameComponent {
	...
	public void processInput(EntityMovement movement) {
		...
		if(movement.fire && (t > lastFireTime + shotDelay_ms)){
			Projectile projectile = new Projectile(entity.world, entity, projectileModel, explosionModel, this.entity.getHardpointWorldPos("HP_CANNON"), this.entity.getRotX(),this.entity.getRotY(),this.entity.getRotZ(),1.0f, shotSpeed, lifetime);
